...
// MAX BPS = 100000
const SENDER_TO_TREASURY_FEE = 0;
const PROVIDER_TO_TREASURY_FEE = 500; // 0.5%
	...
	42161: {
		...
		supportedTokens: {
			USDC: {
				...
				senderToTreasury: SENDER_TO_TREASURY_FEE,
				providerToTreasury: PROVIDER_TO_TREASURY_FEE,
			},
			USDT: {
