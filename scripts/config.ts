...
const NETWORKS = {
	...
	1: {
		...
		TREASURY_FEE_PERCENT: 500, // in BPS i.e 0.5%
		GATEWAY_CONTRACT: "0x8d2C0D398832b814e3814802FF2dC8b8eF4381e5",
		IMPERSONATE_ACCOUNT: "",
	},
	...
	295: {
		...
		TREASURY_FEE_PERCENT: 500, // in BPS i.e 0.5%
		GATEWAY_CONTRACT: "0x17d13B7032944af8B420Ac5bedb12a7D92270478",
		GATEWAY_IMPLEMENTATION: "0x581fD156F8d44814b2E625aA8e1800cb12411138", // 0x9DBe1247364765efcCAC8658487327E1C8D17369
		IMPERSONATE_ACCOUNT: "",
	},
	/**
	 * @dev Hedera Testnet
	...
	296: {
		...
		SUPPORTED_TOKENS: {
			USDC: "0x00000000000000000000000000000000006d30e2",//"0.0.7155938",
		},
		TREASURY_FEE_PERCENT: 500, // in BPS i.e 0.5%
		GATEWAY_CONTRACT: "0x2A934041B005C6A3CdA2DE27749847B87f94D18d",
		GATEWAY_IMPLEMENTATION: "0xc50ac10e427b63510E66296870E3B7c9D2542C41",
		IMPERSONATE_ACCOUNT: "",
	},
};
