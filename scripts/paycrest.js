...
async function main() {
  ...
  const ABNGNGLA = {
    code: ethers.utils.formatBytes32String("000014"),
    name: ethers.utils.formatBytes32String("ABNGNGLA"),
  };
  const CBNINGLA = {
    code: ethers.utils.formatBytes32String("000001"),
    name: ethers.utils.formatBytes32String("CBNINGLA"),
  };
  // const palmpay = {
  ...
  await paycrest.setSupportedInstitutions(currency, [ABNGNGLA, CBNINGLA]);
  console.log(
