...
describe("Ownable settings", function () {
  ...
  //   // console.log("all currencies", currencies.length);
  ...
  //   const currency = ethers.utils.formatBytes32String("NGN");
  //   const zeroIndexBytes = ethers.utils.formatBytes32String("0");
  //   const firstBank = {
  //     code: ethers.utils.formatBytes32String("191"),
  //     name: ethers.utils.formatBytes32String("First Bank"),
  //   };
  ...
  //   const getSupportedNameForAccessBank =
  //     await this.paycrest.getSupportedName(accessBank.code);
